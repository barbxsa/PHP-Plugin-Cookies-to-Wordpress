...
function cookie_manager_add_modal() {
    ...
    <div class="modal__before">
        <div class="content_modal__before">
            <h3><i></i>Consentimento de Cookies</h3>
            <p>Utilizamos cookies para aprimorar sua experiência de navegação, exibir anúncios ou conteúdo personalizado e analisar nosso tráfego. Ao clicar em <b>“Aceitar todos”</b>, você concorda com nosso uso de cookies.</p>
            <div class="flex_btns__modal">
                <button id="gerenciar_cookie_modal">Gerenciar</button>
                <button id="rejeitar_tudo">Rejeitar</button>
                <button id="aceitar_tudo">Aceitar todos</button>
            </div>
        </div>
    </div>
